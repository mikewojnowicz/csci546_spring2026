...
ML Module
\begin{itemize}
\item Reading survey: 10 mins
\item Peer lightning pres: 10 mins
\item Mike's presentation: 25 mins
\item Miscellaneous: 25 mins
\end{itemize}
\end{minipage}
...
Course grades will be determined by the decomposition:
\begin{itemize}
\item Midterm: 30\% 
\item Group Exercise Participation: 10\%  
\item Reading surveys: 20\%
...
Many products (midterm questions, reading surveys, lightning chats) will be graded as follows:
\begin{itemize}
\item 4:  Clear, correct response demonstrating strong understanding of the concept behind the question.
\item 3: Mostly correct with reasonable explanation, but with minor mathematical or conceptual issues. 
\item 2: Shows partial understanding or some useful intuition, but contains significant errors or gaps in reasoning.
\item 1: Minimal understanding demonstrated; response is incomplete, unclear, or only shows limited engagement with the question.
\item 0: No meaningful work shown or question left blank.
\end{itemize}

\section{Reading surveys.} The purpose of reading surveys is to check that you did the reading and tried to understand it.  Questions will tend towards being open-ended, and will be graded as above.
...
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 1C: Diffusion Processes}}} \\
\hline
Thurs & Feb 19 & Brownian motion &  \href{http://www.stat.yale.edu/~pollard/Courses/251.spring2013/Handouts/Chang-notes.pdf}{Chang} Sec 5.1-5.6. Suppl: GS Sec  8.1, 8.5\\
Tues & Feb 24 & Diffusion Processes & \href{http://www.stat.yale.edu/~pollard/Courses/251.spring2013/Handouts/Chang-notes.pdf}{Chang} Sec 6.1-6.5. Suppl:  GS Sec 13.3 \\
Thurs & Feb 26 & Stochastic Calculus & \href{http://www.stat.yale.edu/~pollard/Courses/251.spring2013/Handouts/Chang-notes.pdf}{Chang} Sec 6.7-6.8. Suppl:  GS Sec  13.7\\
Tues & Mar 3 & It\^{o} integral & \href{http://www.stat.yale.edu/~pollard/Courses/251.spring2013/Handouts/Chang-notes.pdf}{Chang} Sec 6.9-6.11. Suppl: GS Sec  13.8-13.9  \\
\hline
...
Tues & Mar 24 & Classic Diffusion Model & Sohl-Dickstein, J., Weiss, E., Maheswaranathan, N., \& Ganguli, S. (2015, June). Deep unsupervised learning using nonequilibrium thermodynamics. In \textit{International conference on machine learning} (pp. 2256-2265).\\
& & & \textit{Lightning chat}: Josh B. \& Racquel\\
Thurs & Mar 26 & Overview of Diffusion Models &  Christopher Bishop (2023), \textit{Deep Learning} (Chapter 20: Diffusion Models). Note: for now, only read Secs 20.1 \& 20.2. \\
& & & \textit{Lightning chat}: Blake \& Matt \\
Tues & Mar 31 & Diffusion exercise &  Code up a simple diffusion model! \\
& & & \textit{Reference:} \url{https://e-dorigatti.github.io/math/deep\%20learning/2023/06/25/diffusion.html} \\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 2B: Diffusion and Score Matching}}} \\
\hline
Thurs & Apr 2  & Classic Score Matching &  Hyvärinen, A. (2005). Estimation of non-normalized statistical models by score matching. \textit{Journal of Machine Learning Research}, 6(4).\\
& & & Supplemental Exercises: \url{https://ericmjl.github.io/score-models/notebooks/01-score-function.html} \\
& & & Supplemental Reading: Christopher Bishop (2023), \textit{Deep Learning} Sec 20.3.1-20.3.3 \\
& & & \textit{Lightning chat}: Sam \& Dillon \\
Tues & Apr 7 & Diffusion with Score Matching & Ho, J., Jain, A., \& Abbeel, P. (2020). Denoising diffusion probabilistic models. \textit{Advances in neural information processing systems}, 33, 6840-6851. \\
%Thurs & Apr 2 & Tweedie's Formula &  Efron, B. (2011). Tweedie’s formula and selection bias. \textit{Journal of the American Statistical Association}, 106(496), 1602-1614.\\
 &  &  & Supplemental topic: Diffusion and variational inference.  Kingma, D., \& Gao, R. (2023). Understanding diffusion objectives as the elbo with simple data augmentation. \textit{Advances in Neural Information Processing Systems}, 36, 65484-65516 \\
 & & & \textit{Lightning chat}: Jacob \& Mike \\
Thurs & Apr 9  & Diffusion and SDEs & Song, Y., Sohl-Dickstein, J., Kingma, D. P., Kumar, A., Ermon, S., \& Poole, B. (2021). Score-based generative modeling through stochastic differential equations. In \textit{Proceedings of the International Conference on Learning Representations (ICLR).} \\
& & & Supplemental Reading: Christopher Bishop (2023), \textit{Deep Learning} Sec 20.3.4\\
& & & \\
 & & & \textit{Lightning chat}: Owen, Ismoiljon \\
\hline
\multicolumn{4}{l}{\textbf{\textcolor{myCOLOR}{\large MODULE 2C: Diffusion with Transformers}}} \\
\hline
Tues & Apr 14   & Intro to Transformers  &  Christopher Bishop (2023), \textit{Deep Learning} (Section 12.1: Attention).  Secs. 12.2-12.4 are optional. \\ 
& & & Supplemental: Sasha Rush's \textit{LLMs in 5 formulas}  \\ 
 & & & \textit{Lightning chat}: Austin, Logan, Tatiana \\
Thurs & Apr 16 &  Attention Exercises & \url{https://classic.d2l.ai/chapter_attention-mechanisms/index.html} \\
...
& & & Supplemental:  \textit{An image is worth 16x16 words: Transformers for image recognition at scale.} \\
& & & Supplemental: Bishop \textit{Deep Learning}, Ch 10: Convolutional Networks \\
 & & & \textit{Lightning chat: Diego, Aubrey} \\
\hline
...
Thurs &  Apr 23 & Conditional score-based diffusion & Tashiro, Y., Song, J., Song, Y., \& Ermon, S. (2021). Csdi: Conditional score-based diffusion models for probabilistic time series imputation. \textit{Advances in neural information processing systems}, 34, 24804-24816. \\
 & & & \textit{Lightning chat: Josh S, Josh C.} \\
  & & & \textit{Guest Lightning chat: Jack Ruder (Ph.D. Student)} \\
Tues &  Apr 28 & Probabilistic weather forecasting  & Price, I., Sanchez-Gonzalez, A., Alet, F., Andersson, T. R., El-Kadi, A., Masters, D.... \& Willson, M. (2025). Probabilistic weather forecasting with machine learning. \textit{Nature}, 637(8044), 84-90. \\
 & & & \textit{Lightning chat: Lina, Laura} \\
\hline
...
During the period of April 29 to May 7 (9 days), you will be working in groups of 2 students on a project related to diffusion.    \alert{Think of this project as an extended version of the ``simple diffusion coding'' project you did on March 31.} The goal is to balance theoretical depth with a working implementation on some interesting dataset. Given the short timeframe and the ``end-of-class'' context, you should focus on feasibility (try to pick a relatively small dataset, so that you don't have to train a massive model from scratch). 

I recommend progressing through the project as follows:

\section{1. Project Scoping and Setup (Days 1--3)}
\begin{itemize}
    \item \textbf{Define the Task:} Choose a specific application such as image generation on a small dataset (e.g., MNIST, CIFAR-10), image inpainting, or unconditional generation for a niche domain like medical icons or textures.  
    \item \textbf{Read necessary material: } If relevant, read through any background material that we didn't cover in class (e.g. U-nets for image modeling, DiffWave for audio modeling, etc.)
    \item \textbf{Select a Framework:} Use established libraries like  PyTorch or Hugging Face Diffusers to avoid building low-level functions from scratch.
    \item \textbf{Acquire Data:} Ensure the dataset is small enough to train within 2--3 days on available hardware.
\end{itemize}

\section{2. Implementation and Training (Days 4--6)}
This phase involves the core technical work of building and refining the model.  
\begin{itemize}

    \item \textbf{Build the Pipeline:} Implement the forward diffusion process (adding noise) and the reverse process (denoising with some architecture, e.g. a U-Net or Transformer).
    \item \textbf{Establish a Training Loop:}
    \begin{itemize}
        \item Sample a batch of observations and a uniform time step $t$.
        \item Add Gaussian noise to the observations based on $t$.
        \item Train the model to predict the added noise using Mean Squared Error (MSE) loss.
    \end{itemize}
    \item \textbf{Iterative Testing:} Start with a tiny subset of data to ensure the loss decreases before committing to a full-scale training run.
\end{itemize}

\section{3. Evaluation and Refinement (Days 7--8)}
Once the model is training, focus on assessing its performance.
\begin{itemize}
    \item \textbf{Qualitative Analysis:} Generate samples at various stages of training.  How do they look? Document ``hallucinations'' or common failure modes.
    \item \textbf{Quantitative Metrics:} Use simple measures like training loss or MSE of the noise prediction to show convergence. To assess the quality of generated samples, you could try reporting standard metrics like FID (Fr\'echet Inception Distance).
    \item \textbf{Hyperparameter Tuning:} If time permits, experiment with different approaches (e.g. different model architectures or noise schedules, like linear vs.\ cosine).
\end{itemize}

\section{4. Final Documentation (Day 9)} The final day should be dedicated to reporting results and ensuring the work is reproducible. Please submit a report (ideally no longer than 5 pages) that includes the following sections:

\begin{itemize}
    \item \textbf{Introduction.} Clearly state the project goals and provide brief context for the problem being addressed.
    
    \item \textbf{Methodology.} Describe the model design, loss functions, and any data preprocessing steps (e.g., normalization, resizing). Include a link to your codebase to support reproducibility. Code should be well-organized and appropriately commented.
    
    \item \textbf{Results.} Present your findings, preferably with visualizations (e.g., plots or generated samples) to illustrate model performance.
    
    \item \textbf{Conclusion.} Summarize the key insights gained from the project. Discuss limitations and identify open questions or directions for future work.
\end{itemize}


\newpage
\makeFullPage
\section{Final Project Grading Rubric}
...
Introduction & 10 &
Clear statement of project goals and motivation. Provides appropriate context. \\

Methodology & 25 &
Model design, loss functions, and preprocessing steps are clearly described. Approach is reasonable and well-justified. Codebase is provided and organized. \\

Implementation \& Effort & 20 &
Evidence of a working implementation. Appropriate use of tools/frameworks. Demonstrates effort in building, debugging, and iterating on the model. \\

Results \& Evaluation & 25 &
Results are clearly presented (e.g., plots, samples). Includes some evaluation of model performance (qualitative and/or quantitative). \\

Conclusion \& Insight & 10 &
Clear summary of findings. Thoughtful discussion of limitations and possible improvements. \\

Clarity \& Reproducibility & 10 &
Paper is well-written and organized. Code is accessible, readable, and sufficiently documented to reproduce results. \\
