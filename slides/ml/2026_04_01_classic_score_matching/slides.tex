...
% DOCUMENT 
%%%
\title{04/01/2026: Classic Score Matching}
...
\vfill 
\begin{figure} \includegraphics[width=.3\textwidth]{images/score_function} 
...
\only<2>{
\vfill 
\begin{figure} \includegraphics[width=.45\textwidth]{images/langevin_sampling} 
...
\only<3->{
\vfill 
\begin{figure} \includegraphics[width=.3\textwidth]{images/langevin_sampling} 
\caption{Three trajectories, all starting from the center of the plot.}
\end{figure}
\vspace{-.4cm}
}
