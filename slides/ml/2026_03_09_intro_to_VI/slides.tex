...
We immediately obtain a nice form
...
\colorbox{blue!30}{\textbf{Remark.}} The entropy term encourages spread-out distributions, preventing $q$ from collapsing to a point mass.
}
